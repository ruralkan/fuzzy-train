...
with app_tab:
    ...
    data_file = st.text_input('Training Data File Path',key='data', value='/home/ruralkan/code/certified-developer/MLOps_Professional/mlops_capstone/store/datasets/robot_maintenance/train.pkl')
    ...
    mlflow_tracking_uri = st.text_input('Tracking URI',key='uri', value='/home/ruralkan/code/certified-developer/MLOps_Professional/mlops_capstone/store/models/robot_maintenance')
    ...
    scaler_destination = st.text_input('Scaler Destination',key='scalerdest', value= '/home/ruralkan/code/certified-developer/MLOps_Professional/mlops_capstone/store/outputs/robot_maintenance') 
